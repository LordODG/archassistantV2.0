...
public class ArcAssistantService {
    ...
    @WebMethod(operationName = "ListarModulosDeProyecto")
    public List<Modulo> ListarModulosDeProyecto(@WebParam(name = "parameter") Proyecto parameter){
        modB = new ModuloBean();
        return modB.ListarModulosDeProyecto(parameter);
    }
